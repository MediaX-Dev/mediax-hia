        ...
        <div className="row">
          ...
          <div className="mt-4 mt-sm-5 col-md-4 col-sm-6 d-sm-flex justify-content-center">
            <div className="foot-link">
              ...
              <ul>
                <li><a href='https://happeninginagra.com/contact-us'><i class="far fa-angle-right"></i> Contact Us</a></li>
                <li><a href='https://happeninginagra.com/privacy-policy'><i class="far fa-angle-right"></i> Privacy policy</a></li>
                <li><a href='https://happeninginagra.com/refund-policy'><i class="far fa-angle-right"></i> Refund and cancellation policy</a></li>
                <li><a href='https://happeninginagra.com/terms-n-conditions'><i class="far fa-angle-right"></i> Terms & conditions</a></li>
